...
Use these previous prompts for inspiration and to avoid repetition (DO NOT reuse their themes or elements directly, but learn from their structure and concepts if helpful):
{{PROMPTS}}
